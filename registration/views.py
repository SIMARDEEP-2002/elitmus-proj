...
def membersRegister(request):
    ...
    if request.method=='POST':
        ...
        m1present = request.POST["m1Name"]!="" and request.POST["m1Email"]!="" and request.POST["m1Discord"]!="" and request.POST["m1RollNo"]!="" and request.POST["m1PhoneNo"]!=""
        ...
        if m1present:
            to_list.append(m1Data['email'])
            if m2present:
                to_list.append(m2Data['email'])            
